...
export const FAQ = [
  ...
  },
  {
    ...
    a: "The reference app in the repository is the thing you can run and read: a whole workspace AI SaaS — sign-up, workspaces, the shell, chat, billing, usage, artifacts — built only from these npm packages and blocks, with no private fork underneath it. It is generated by the CLI rather than written, and CI fails if a single file drifts from what create and shadcn add would give you, so it is the same app you get.",
  },
  {
