...
<!-- Generated by apps/site/scripts/docs.mjs from packages/cli/src (usage and command doc comments) and packages/cli/templates/manifest.json. Edit that, then run `pnpm sync`. -->
