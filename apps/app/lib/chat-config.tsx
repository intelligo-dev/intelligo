...
/**
 * The reference app's binding: an identity for the header and four
 * starters (message keys, resolved namespace-less — see the module doc
 * comment). The last one triggers the stub model's `saveArtifact` tool
 * call, so the tool → artifact path is one click from an empty chat.
 */
export const chatConfig: ChatConfig = {
