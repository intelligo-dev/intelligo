...
description: "The Next.js adapter: the one Intelligo package that imports next/*, binding request context, auth routes and Route Handler guards."
order: 6
label: "next"
---
