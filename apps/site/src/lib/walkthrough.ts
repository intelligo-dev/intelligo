...
export const WALKTHROUGH: WalkthroughStep[] = [
  ...
  },
  {
    ...
    label: "verify",
    route: "/verify-email",
    item: "auth-email-verification",
    pkg: "@intelligo-dev/auth",
    hotspot: "sendVerificationEmail()",
    ownership: "consumer source",
    scene: "verify",
  },
  {
    ...
    item: "onboarding",
    pkg: "@intelligo-dev/auth",
    hotspot: "createOnboardingService()",
    ownership: "consumer source",
    scene: "workspace",
  },
  {
    ...
    label: "dashboard",
    route: "/dashboard",
    item: "app-shell · dashboard",
    pkg: "@intelligo-dev/core",
    hotspot: "listConversations()",
    ownership: "consumer source",
    scene: "dashboard",
  },
  {
  ...
  },
  {
    ...
    pkg: "@intelligo-dev/billing",
    hotspot: "createCheckoutSession()",
    ownership: "consumer source",
    scene: "billing",
  },
  {
    ...
    route: "/usage",
    item: "usage",
    pkg: "@intelligo-dev/executions",
    hotspot: "summarizeExecutions()",
    ownership: "consumer source",
    scene: "usage",
  },
  {
    ...
    route: "/chat",
    item: "chat",
    pkg: "@intelligo-dev/executions · core",
    hotspot: "executions.begin()",
    ownership: "consumer source",
    scene: "chat",
  },
  {
  ...
  },
  {
    ...
    route: "/admin",
    item: "—",
    pkg: "@intelligo-dev/admin · audit",
    hotspot: "recordAuditEvent()",
