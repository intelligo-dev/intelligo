...
<!-- Generated by apps/site/scripts/docs.mjs from packages/cli/templates/app-scaffold/env.example.tpl — the `.env.example` every new app gets. Edit that, then run `pnpm sync`. -->
